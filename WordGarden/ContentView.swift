...
//  WordGarden
//
//  Created by CABRERA, NATHAN on 1/12/26.
//
...
struct ContentView: View {
    ...
    @State private var lettersGussed = ""
            ...
            if playAgainHidden {
                HStack {
                    TextField("", text: $guessedLetter)
                        ...
                        .onSubmit {
                            // As long as guessedLetter is not an emptty String we can continue, otherwise don't do anything
    ...
    func updateGamePlay() {
        if !wordToGuess.contains(guessedLetter) {
            guessesRemaining -= 1
            // Animate crumbling lead and play the incorrect sound
